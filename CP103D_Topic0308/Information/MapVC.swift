...
class MapVC: UIViewController, MKMapViewDelegate {
    ...
    func getSpotList() -> [Spot]{
        var spotList = [Spot]()
        let shulin = Spot(image: UIImage(named: "shulin.png")!, name: "秀泰生活新北樹林店", address: "23847 新北市樹林區樹新路40-6號1F", time: "週一〜週日 11:00〜22:00" , latitude: 24.995726, longitude: 121.428143)
