//
//  ManagerWomanTableViewController.swift
//  CP103D_Topic0308
//
...
class ManagerWomanTableViewController: UITableViewController {
    var goods = [Good]()
    ...
    func tableViewAddRefreshControl() { //  refresh
        ...
        refreshControl.addTarget(self, action: #selector(dowloadWomanGoods), for: .valueChanged)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "managerWomanTableViewCell", for: indexPath) as! ManagerWomanTableViewCell
        cell.managerWomancollevtionviewOutlet.tag = indexPath.section
        cell.managerWomancollevtionviewOutlet.reloadData()
        return cell
    }
...
extension ManagerWomanTableViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "managerWomanCollectionViewCell", for: indexPath) as! ManagerWomanCollectionViewCell
        ...
        executeTask(url_server!, requestParam) { (data, response, error) in
            if error == nil {
                ...
                DispatchQueue.main.async { cell.managerWomanImageview.image = image }
            } else {
                print(error!.localizedDescription)
            }
        }
        
        cell.managerWomanLabel.text = goodsSubclass[indexPath.row].name
        return cell
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "managerWomanSegue", sender: goodDetail)
    }
